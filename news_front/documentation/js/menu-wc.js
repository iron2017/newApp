                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/NewsArticleComponent.html" data-type="entity-link" >NewsArticleComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/NewsFilterComponent.html" data-type="entity-link" >NewsFilterComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/NewsListComponent.html" data-type="entity-link" >NewsListComponent</a>
                            </li>
                            <li class="link">
